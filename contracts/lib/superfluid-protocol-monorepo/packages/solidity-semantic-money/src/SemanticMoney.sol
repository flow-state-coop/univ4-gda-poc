...
function mt_t_eq(Time a, Time b) pure returns (bool) {
    return Time.unwrap(a) == Time.unwrap(b);
}

function mt_t_neq(Time a, Time b) pure returns (bool) {
    return Time.unwrap(a) != Time.unwrap(b);
}

function mt_t_le(Time a, Time b) pure returns (bool) {
    return Time.unwrap(a) < Time.unwrap(b);
}

function mt_t_lte(Time a, Time b) pure returns (bool) {
    return Time.unwrap(a) <= Time.unwrap(b);
}

function mt_t_gt(Time a, Time b) pure returns (bool) {
    return Time.unwrap(a) > Time.unwrap(b);
}

function mt_t_gte(Time a, Time b) pure returns (bool) {
    return Time.unwrap(a) >= Time.unwrap(b);
}
...
function mt_v_eq(Value a, Value b) pure returns (bool) {
    return Value.unwrap(a) == Value.unwrap(b);
}

function mt_v_neq(Value a, Value b) pure returns (bool) {
    return Value.unwrap(a) != Value.unwrap(b);
}

function mt_v_le(Value a, Value b) pure returns (bool) {
    return Value.unwrap(a) < Value.unwrap(b);
}

function mt_v_lte(Value a, Value b) pure returns (bool) {
    return Value.unwrap(a) <= Value.unwrap(b);
}

function mt_v_gt(Value a, Value b) pure returns (bool) {
    return Value.unwrap(a) > Value.unwrap(b);
}

function mt_v_gte(Value a, Value b) pure returns (bool) {
    return Value.unwrap(a) >= Value.unwrap(b);
}
...
function mt_v_inv(Value a) pure returns (Value) {
    return Value.wrap(-Value.unwrap(a));
}
...
function mt_u_eq(Unit a, Unit b) pure returns (bool) {
    return Unit.unwrap(a) == Unit.unwrap(b);
}

function mt_u_neq(Unit a, Unit b) pure returns (bool) {
    return Unit.unwrap(a) != Unit.unwrap(b);
}

function mt_u_le(Unit a, Unit b) pure returns (bool) {
    return Unit.unwrap(a) < Unit.unwrap(b);
}

function mt_u_lte(Unit a, Unit b) pure returns (bool) {
    return Unit.unwrap(a) <= Unit.unwrap(b);
}

function mt_u_gt(Unit a, Unit b) pure returns (bool) {
    return Unit.unwrap(a) > Unit.unwrap(b);
}

function mt_u_gte(Unit a, Unit b) pure returns (bool) {
    return Unit.unwrap(a) >= Unit.unwrap(b);
}
...
function mt_u_inv(Unit a) pure returns (Unit) {
    return Unit.wrap(-Unit.unwrap(a));
}
...
function mt_r_eq(FlowRate a, FlowRate b) pure returns (bool) {
    return FlowRate.unwrap(a) == FlowRate.unwrap(b);
}

function mt_r_neq(FlowRate a, FlowRate b) pure returns (bool) {
    return FlowRate.unwrap(a) != FlowRate.unwrap(b);
}

function mt_r_le(FlowRate a, FlowRate b) pure returns (bool) {
    return FlowRate.unwrap(a) < FlowRate.unwrap(b);
}

function mt_r_lte(FlowRate a, FlowRate b) pure returns (bool) {
    return FlowRate.unwrap(a) <= FlowRate.unwrap(b);
}

function mt_r_gt(FlowRate a, FlowRate b) pure returns (bool) {
    return FlowRate.unwrap(a) > FlowRate.unwrap(b);
}

function mt_r_gte(FlowRate a, FlowRate b) pure returns (bool) {
    return FlowRate.unwrap(a) >= FlowRate.unwrap(b);
}
...
function mt_r_inv(FlowRate a) pure returns (FlowRate) {
    return FlowRate.wrap(-FlowRate.unwrap(a));
}
...
library SemanticMoney {
    ...
    function rtb(PDPoolMemberMU memory a, Time t) internal pure returns (Value v) {
        return a.m._settled_value
            + (a.i._wrapped_particle.rtb(t) - a.m._synced_particle.rtb(a.m._synced_particle.settled_at())).mul(
                a.m.owned_units
            );
    }
    ...
    function shift2(BasicParticle memory a, BasicParticle memory b, Value x)
        internal
        pure
    ...
    function flow2(BasicParticle memory a, BasicParticle memory b, FlowRate r, Time t)
        internal
        pure
        returns (BasicParticle memory m, BasicParticle memory n)
    {
    ...
    function shift_flow2b(BasicParticle memory a, BasicParticle memory b, FlowRate dr, Time t)
        internal
        pure
        returns (BasicParticle memory m, BasicParticle memory n)
    {
    ...
    function shift_flow2a(BasicParticle memory a, BasicParticle memory b, FlowRate dr, Time t)
        internal
        pure
        returns (BasicParticle memory m, BasicParticle memory n)
    {
    ...
    function shift2b(BasicParticle memory a, PDPoolIndex memory b, Value x)
        internal
        pure
    ...
    function flow2(BasicParticle memory a, PDPoolIndex memory b, FlowRate r, Time t)
        internal
        pure
    ...
    function shift_flow2b(BasicParticle memory a, PDPoolIndex memory b, FlowRate dr, Time t)
        internal
        pure
        returns (BasicParticle memory m, PDPoolIndex memory n, FlowRate r1)
    {
