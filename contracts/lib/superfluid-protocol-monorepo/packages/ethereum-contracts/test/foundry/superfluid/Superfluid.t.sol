...
contract SuperfluidIntegrationTest is FoundrySuperfluidTester {
    ...
    function testRevertRegisterMax256Agreements() public {
        ...
        ISuperAgreement[] memory mocks = new ISuperAgreement[](maxNumAgreements);
        ...
        AgreementMock badmock =
            new AgreementMock(address(sf.host), keccak256(abi.encode("max.bad")), maxNumAgreements + 1);
