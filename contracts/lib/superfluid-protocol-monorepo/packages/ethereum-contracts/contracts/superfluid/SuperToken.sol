...
import {
    ISuperfluid, ISuperToken, IERC20, IPoolAdminNFT, IPoolMemberNFT
...
contract SuperToken is UUPSProxiable, SuperfluidToken, ISuperToken {
    ...
    function operationUpgradeTo(address account, address to, uint256 amount) external virtual override onlyHost {
        _upgrade(msg.sender, account, to, amount, "", "");
    }

    function operationDowngradeTo(address account, address to, uint256 amount) external virtual override onlyHost {
