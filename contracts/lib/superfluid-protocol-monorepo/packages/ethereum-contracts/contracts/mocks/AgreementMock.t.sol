...
contract AgreementMock is AgreementBase {
    ...
    constructor(address host, bytes32 t, uint256 v) AgreementBase(host) {
        _type = t;
        _version = v;
    }
    ...
    function terminateAgreementFor(ISuperfluidToken token, bytes32 id, uint256 dataLength) external {
