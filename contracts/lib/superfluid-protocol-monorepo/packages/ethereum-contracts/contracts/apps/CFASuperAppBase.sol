...
abstract contract CFASuperAppBase is ISuperApp {
     ...
     */
    function selfRegister(bool activateOnCreated, bool activateOnUpdated, bool activateOnDeleted) public {
    ...
    function getConfigWord(bool activateOnCreated, bool activateOnUpdated, bool activateOnDeleted)
        public
        pure
        returns (uint256 configWord)
    {
        configWord = SuperAppDefinitions.APP_LEVEL_FINAL | SuperAppDefinitions.BEFORE_AGREEMENT_CREATED_NOOP;
