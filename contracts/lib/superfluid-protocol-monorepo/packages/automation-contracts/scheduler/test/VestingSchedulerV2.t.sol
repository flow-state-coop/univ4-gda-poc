...
contract VestingSchedulerV2Tests is FoundrySuperfluidTester {
    ...
    function testAssertScheduleDoesNotExist(address superToken, address sender, address receiver) public {
    ...
    function test_getMaximumNeededTokenAllowance_should_end_with_zero_if_extreme_ranges_are_used(
        ...
        // Arrange
        IVestingSchedulerV2.VestingSchedule memory expectedSchedule =
