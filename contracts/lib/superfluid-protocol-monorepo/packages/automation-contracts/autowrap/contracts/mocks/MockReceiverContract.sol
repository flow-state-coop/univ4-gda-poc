...
contract MockReceiverContract {
    ...
    function createFlow(ISuperToken token, address receiver, int96 flowRate) public {
        host.callAgreement(
            cfa, abi.encodeWithSelector(cfa.createFlow.selector, token, receiver, flowRate, new bytes(0)), "0x"
        );
    }
