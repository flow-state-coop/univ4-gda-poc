...
interface IStrategy {
    ...
    function wrap(address user, ISuperToken superToken, uint256 superTokenAmount) external;
    ...
    function isSupportedSuperToken(ISuperToken superToken) external view returns (bool);
